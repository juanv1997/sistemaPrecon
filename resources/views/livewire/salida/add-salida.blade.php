<div>
    ...
    <div class="py-4">
        ...
        <div class="bg-white shadow-xl flex-row rounded-lg border-2 border-gray-500">
            ...
            <div class="flex space-x-3 p-3 justify-center font-semibold">
                ...
                <select class="block appearance-none  bg-grey-lighter border-gray-600 focus:ring-gray-700 focus:border-transparent text-grey-darker rounded-full" id="cbOption" onchange="changeOption()" wire:model.defer="inputType">
            ...
            {{-- <div id="tab-contents" wire:ignore.self> --}}
                ...
                <div id="product" class="p-4" wire:ignore.self>
                    ...
                    <div  class="-mx-2 md:flex mb-3">
                                ...
                                <div class="md:w-1/4 px-3 mb-6 md:mb-0">
                                    ...
                                    <select  class="block appearance-none w-full bg-grey-lighter border-gray-600 focus:ring-gray-700 focus:border-transparent text-grey-darker rounded-full" id="cbTipo"  wire:model="tipoProducto" >
                                ...
                                <div class="md:w-4/5 px-3 mb-6 md:mb-0">
                                    ...
                                    <select  id="cbPro" class="block appearance-none w-full bg-grey-lighter border-gray-600 focus:ring-gray-700 focus:border-transparent text-grey-darker rounded-full"  wire:model.defer="producto"  onchange="getStockPro()">
                ...
                <div id="code" class="hidden p-4" wire:ignore.self>
                    ...
                    <div class="mx-8 md:flex mb-3 justify-center">
                                ...
                                <x-jet-button wire:click="getStockProducto" wire:loading.remove wire:target="getStockProducto">
                                ...
                                <div  class="md:w-1/3 px-3 ">
                                    ...
                                    <input type="text" placeholder="Ingrese el código del producto" id="txtCode"
                                    ...
                                    <div  wire:ignore id="searchTab" class=" hidden inline-block bg-white rounded overflow-y-auto  h-44 w-72 absolute border-2 border-black">

                                        <ul id="searchList">
                                              

                                            <div class="items-center text-center px-2 py-4 hidden" id="notFoundMsg">

                                                <label class="" >Lo sentimos, no se encontro ningun resultado</label>
                                ...
                                <div  class="md:w-1/3 px-3 ">
                                    ...
                                    <select id="searchFilter" class="block appearance-none w-full bg-grey-lighter border-gray-600 focus:ring-gray-700 focus:border-transparent text-grey-darker rounded-full" >
                                ...
                                <div class="w-1/6">
                                    ...
                                    <div wire:loading.remove wire:target="getStockProducto" class=" flex space-x-7 text-center" >
                        ...
                        {{-- 
                                    ...
                                    <div wire:loading wire:target="getStockProducto">
    ...
    {{-- Loading para cambiar de tipo de producto --}}

    <div wire:loading  wire:target="tipoProducto" class="fixed inset-0 px-96 bg-gray-800 bg-opacity-70">

        <div class="text-center py-48 px-72">

            <div class="w-48 h-48  rounded-md">
                ...
                <div class="mt-3 text-gray-200 font-sans text-lg ">Procesando...</div>
