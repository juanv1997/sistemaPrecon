<div>
    ...
    <x-modal-small>
      ...
      <x-slot name="icon">
        ...
        <x-slot name="targetMethodLoading">addEntrada</x-slot>
  
        <x-slot name="loadingMessage">Cargando...</x-slot>
  
        <x-slot name="modalId">addEntrada</x-slot>
  
        <x-slot name="eventClick">addEntrada</x-slot>
  
        <x-slot name="buttonText">Agregar</x-slot>
  
        <x-slot name="title">Agregar entrada</x-slot>
  
         ¿Seguro de agregar la entrada?
        ...
        <div class="bg-white shadow-2xl flex-row rounded-lg border-2 border-gray-500 ">
                    ...
                    @if (count($productos)!=0)
                        <div class="flex space-x-7 justify-end ">
                            ...
                            <div class="px-3 relative">
                                ...
                                <span  class="text-center absolute bg-gray-200 text-gray-800 font-bold w-5 h-5 text-xs p-0 leading-5 rounded-full -right-0 top-3">{{count($productos)}} </span>
                            </div>
            ...
            <div class="rounded-lg shadow-2xl px-11 py-4">
                ...
                @empty(!$productos)
                    <div class="py-2">
                        <center>
                            <x-jet-button  onclick="addEntrada()" >
