            ...
            <div id="product" class="p-4" wire:ignore.self>
                                ...
                                <div  class="-mx-2 md:flex mb-3">
                                            ...
                                            <div class="md:w-1/4 px-3 mb-6 md:mb-0">
                                                ...
                                                <select  class="block appearance-none w-full bg-grey-lighter border-gray-600 focus:ring-gray-700 focus:border-transparent text-grey-darker rounded-full" id="cbTipo"  wire:model="tipoProducto"  onchange="resetToDefault()" >
